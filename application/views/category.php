<div class="content-wrapper">
  ...
  <div class="box">
    <h3>Category (<?php echo sizeof($all_category); ?>) <a href="javascript:;" class="btn btn-primary pull-right" data-toggle="modal" 
    data-target="#myModal">Add New Category</a></h3>
